package com.pengzhen.bcm.common.security;
...
import com.pengzhen.bcm.common.utils.Encodes;
import com.pengzhen.bcm.common.utils.Exceptions;
import com.pengzhen.bcm.modules.sys.service.SystemService;
...
public class Cryptos {
	...
	public static void main(String[] args) {
		...
		String password = SystemService.entryptPassword(plainPassword);
		System.out.println(password);
		System.out.println(SystemService.validatePassword(plainPassword, password));
		password = SystemService.entryptPassword(plainPassword);
		System.out.println(password);
		System.out.println(SystemService.validatePassword(plainPassword, password));

		String mac = "00-50-56-A0-52-D5";
		String key = Cryptos.aesEncrypt(mac).toUpperCase();
		System.out.println(key);
		System.out.println(Cryptos.aesDecrypt(key));
